...
using static Hearthstone_Deck_Tracker.Controls.Overlay.WotogIconsStyle;
...
namespace Hearthstone_Deck_Tracker.Windows
{
	public partial class OverlayWindow
	{
		...
		private void UpdateIcons()
		{
			...
			WotogIconsPlayer.WotogIconsStyle = showPlayerCthunIcon && showPlayerSpellsIcon
			...
			WotogIconsOpponent.WotogIconsStyle = showOpponentCthunIcon && showOpponentSpellsIcon
